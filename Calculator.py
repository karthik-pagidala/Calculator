...
root=Tk()
root.title("OREVA")
e=Entry(root,width=50,borderwidth=20,fg="grey")
...
buttonsub=Button(root,text="-",padx=40,pady=40,command=sub)
buttonmul=Button(root,text="x",padx=40,pady=40,command=mul)
buttondiv=Button(root,text="/",padx=40,pady=40,command=div)
buttonequl=Button(root,text="=",padx=40,pady=40,command=equal)
buttonclear=Button(root,text="Clr",padx=40,pady=40,command=clear)
